 ...
 * AB_Constraints.h
 *
 * Common Constraint Header for an Articulating Biped.
 *
...
enum constNames { dx_const, y_const, dy_const, phi_const, dphi_const,
                  ...
                  betaL_const, dbetaL_const, ubetaL_const, dubetaL_const,
                  betaR_const, dbetaR_const, ubetaR_const, dubetaR_const,
                  TalphaL_const, TalphaR_const,
                  TbetaL_const, TbetaR_const
};
...
static const char *motion_file_name = "AB_MOTION.txt";
static const char *plot_file_name = "AB_PLOT.txt";
void motion_output
(
		long   *imos,      ///< index of model stage (I)
		long   *imsn,      ///< index of m.s. node on current model stage (I)
