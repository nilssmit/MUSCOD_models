...
%PathTo2DBiped   = '/home/cremy/muscodgaitcreat/2013_04_13_SeriesParallel2DBiped/';
%PathTo1DMonoped = '/home/cremy/muscodgaitcreat/2013_04_30_SeriesParallel1DMonoped/';
...
% Yet they will converge to solutions 
...
currentPath = pwd;
system(['cp ','BaseData/RAMone_*_BASE_00.dat ', PathToAB,'DAT/']);
...
[MuscodResults_01(5), cmdout] = system([PathToMuscod,' RAMone_Run_posElWork_BASE_00']);
[MuscodResults_01(6), cmdout] = system([PathToMuscod,' RAMone_Run_totElLoss_BASE_00']);
cd(currentPath);
% Copy back to BaseData/
system(['cp ',PathToAB,'RES/RAMone_*_BASE_00.* ',pwd,'/BaseData/']);
% Clean up DAT and RES folders
system(['rm ',PathToAB,'DAT/*.* ']);
system(['rm ',PathToAB,'RES/*.* ']);

% PlotMuscodResultsRAMone('BaseData/RAMone_Walk_posActWork_BASE_00',[1 2 3 4 5 6]);
% PlotMuscodResultsRAMone('BaseData/RAMone_Walk_posElWork_BASE_00',[1 2 3 4 5 6]);
% PlotMuscodResultsRAMone('BaseData/RAMone_Walk_totElLoss_BASE_00',[1 2 3 4 5 6]);
% PlotMuscodResultsRAMone('BaseData/RAMone_Run_posActWork_BASE_00',[1 2 3 4 5 6]);
% PlotMuscodResultsRAMone('BaseData/RAMone_Run_posElWork_BASE_00',[1 2 3 4 5 6]);
% PlotMuscodResultsRAMone('BaseData/RAMone_Run_totElLoss_BASE_00',[1 2 3 4 5 6]);
% disp(MuscodResults_01); % All converged on 7/15/2013
...
% datStruct.p(4) = 6;  % enforce constraints on actuation
% datStruct.p_fix(6) = 0; % optimize transmission values
datStruct.p_fix(9) = 0;  %optimize u_offset
datStruct.p(9) = 0.15;
...
currentPath = pwd;
system(['cp ',pwd,'/BaseData/HOPPING_1D_*_BASE_01.dat ', PathToAB,'DAT/']);
% SWITCH TO PROJECT DIRECTORY AND RUN MUSCOD THERE
cd(PathToAB);
...
cd(currentPath);
% Copy back to BaseData/
system(['cp ',PathToAB,'RES/HOPPING_1D_*_BASE_01.* ',pwd,'/BaseData/']);
% Clean up DAT and RES folders
system(['rm ',PathToAB,'DAT/*.* ']);
system(['rm ',PathToAB,'RES/*.* ']);
...
ProcessParameterStudy('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_posMeWork', PathToAB, PathToMuscod);
%
...
ProcessParameterStudy('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_posActWork', PathToAB, PathToMuscod);
%
...
ProcessParameterStudy('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_posElWork', PathToAB, PathToMuscod);
%
%load('BaseData/HOPPING_1D_SL_posMeWork_BASE_01.mat','datStruct');
...
ProcessParameterStudy('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_totElLoss', PathToAB, PathToMuscod);
%
...
ProcessParameterStudy('ParameterStudies/StiffnessStudy_HOPPING_1D_PL_posActWork', PathToAB, PathToMuscod);
%
...
ProcessParameterStudy('ParameterStudies/StiffnessStudy_HOPPING_1D_PL_posElWork', PathToAB, PathToMuscod);
%
...
ProcessParameterStudy('ParameterStudies/StiffnessStudy_HOPPING_1D_PL_totElLoss', PathToAB, PathToMuscod);
...
ProcessParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_posMeWork_02', PathToAB, PathToMuscod);
%load('BaseData/HOPPING_1D_SL_posActWork_BASE_01.mat','datStruct');
%datStruct = UpdateDatStruct(datStruct, 'BaseData/HOPPING_1D_SL_posActWork_BASE_01', 30,10,1);
...
ProcessParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_posActWork_02', PathToAB, PathToMuscod);
%load('BaseData/HOPPING_1D_SL_posElWork_BASE_01.mat','datStruct');
%datStruct = UpdateDatStruct(datStruct, 'BaseData/HOPPING_1D_SL_posElWork_BASE_01', 30,10,1);
%CreateParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_posElWork_02', datStruct, 'p',5,StiffnessValues) 
ProcessParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_posElWork_02', PathToAB, PathToMuscod);
%load('BaseData/HOPPING_1D_SL_posMeWork_BASE_01.mat','datStruct');
%datStruct = UpdateDatStruct(datStruct, 'BaseData/HOPPING_1D_SL_totElLoss_BASE_01', 30,10,1);
%CreateParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_totElLoss_02', datStruct, 'p',5,StiffnessValues) 
ProcessParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_SL_totElLoss_02', PathToAB, PathToMuscod);
%load('BaseData/HOPPING_1D_PL_posActWork_BASE_01.mat','datStruct');
%datStruct = UpdateDatStruct(datStruct, 'BaseData/HOPPING_1D_PL_posActWork_BASE_01', 30,10,1);
...
ProcessParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_PL_posActWork_02', PathToAB, PathToMuscod);
%load('BaseData/HOPPING_1D_PL_posElWork_BASE_01.mat','datStruct');
%datStruct = UpdateDatStruct(datStruct, 'BaseData/HOPPING_1D_PL_posElWork_BASE_01', 30,10,1);
%CreateParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_PL_posElWork_02', datStruct, 'p',5,StiffnessValues) 
ProcessParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_PL_posElWork_02', PathToAB, PathToMuscod);
%load('BaseData/HOPPING_1D_PL_totElLoss_BASE_01.mat','datStruct');
%datStruct = UpdateDatStruct(datStruct, 'BaseData/HOPPING_1D_PL_totElLoss_BASE_01', 30,10,1);
%CreateParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_PL_totElLoss_02', datStruct, 'p',5,StiffnessValues) 
ProcessParameterStudy_Randomized('ParameterStudies/StiffnessStudy_HOPPING_1D_PL_totElLoss_02', PathToAB, PathToMuscod);
